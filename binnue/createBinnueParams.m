function [paramsNonUniformTransferEntropy] = createBinnueParams(varargin)
% 
% Syntax:
% 
...
paramsNonUniformTransferEntropy.numQuantLevels        = varargin{1,7};
paramsNonUniformTransferEntropy.entropyFun            = varargin{1,8};
paramsNonUniformTransferEntropy.preProcessingFun      = varargin{1,9};
paramsNonUniformTransferEntropy.secondTermCaseVect    = varargin{1,10};
paramsNonUniformTransferEntropy.numSurrogates         = varargin{1,11};
paramsNonUniformTransferEntropy.alphaPercentile       = varargin{1,12};
% ******** Set the following fields together *******
paramsNonUniformTransferEntropy.genCondTermFun        = varargin{1,13};
paramsNonUniformTransferEntropy.usePresent            = varargin{1,14};
paramsNonUniformTransferEntropy.scalpConduction       = varargin{1,15};
% **************************************************
