function [mutualInfo mutualInfoMtx] = nearNeiMutualInformation(dataPreprocessed,idTargets,idConditionalTerm,metric,k,funcDir,homeDir)
% 
% Syntax:
% 
...
%     distance                      = cell(1,numTargets);
    ...
    for i = 1 : numTargets
        [mutualInfo(1,i)]       = evalNNMutualInfo(mutualInfoMtx{1,i}',metric,k,funcDir,homeDir);
    end