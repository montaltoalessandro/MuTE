function entropyTerm = nearNeiConditionalEntropyRiduced(dataPreprocessed,idTargets,idConditionalTerm,metric,k,funcDir,distance)
% 
% Syntax:
% 
% entropyTerm = nearNeiConditionalEntropyRiduced(dataPreprocessed,idTargets,idConditionalTerm,metric,k,funcDir,distance)
% 
% Description:
% 
...
% usually the calling function is the method function
    ...
    for i = 1 : numTargets
        [entropyTerm(1,i)]       = evalNearNeiConditionalEntropy(entropyMtx{1,i}',metric,k,funcDir,distance);
    end
