function [mutualInfo mutualInfoMtx] = nearNeiConditionalMutualInformation(dataPreprocessed,idTargets,idConditionalTerm,metric,k,funcDir,homeDir)
% 
% Syntax:
% 
% [mutualInfo mutualInfoMtx] = nearNeiConditionalMutualInformation(dataPreprocessed,idTargets,idConditionalTerm,metric,k,funcDir,homeDir)
% 
% Description:
% 
...
%     distance                      = cell(1,numTargets);
    ...
    for i = 1 : numTargets
        [mutualInfo(1,i)]       = evalConditionalMutualInfo(mutualInfoMtx{1,i}',metric,k,funcDir,homeDir);
    end