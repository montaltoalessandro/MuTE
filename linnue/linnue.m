function [output] = linnue(data,methodParams)
% 
% Syntax:
% 
...
%     fprintf('\n\nFirst Conditional Entropy Term Evaluation...');
    if (methodParams.usePresent == 0)
        firstEntropyTerm       = evaluateLinearNonUniformEntropy2(dataPreprocessed,idTargets,idDrivers,finalCandidatesMtx,secondEntropyTerm,minEntropies);
    else
    ...
    %     idDrivers taken once
        ...
        firstEntropyTerm       = evaluateLinearNonUniformEntropy2(dataPreprocessed,idTargets,reducedDrivers,finalCandidatesMtx,secondEntropyTerm,minEntropies);
    end
%     fprintf('Done\n');
