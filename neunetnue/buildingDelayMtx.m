function [entropyMtx] = buildingDelayMtx(data,idTargets,idConditionalTerm)
% 
% Syntax:
% 
...
%     building the delayMtx
    ...
    parfor i = 1 : numTargets %parfor
        ...
        for j = 1 : numDelays(1,i)
            entropyMtx{1,i}(j,:)      = data(currIdConditionalTerm(j,1) , (maxDelays(1,i)+1-currIdConditionalTerm(j,2):numPoints-currIdConditionalTerm(j,2)));
        end
        entropyTarVect              = data(idTargets(1,i) , maxDelays(1,i) + 1 : end);
