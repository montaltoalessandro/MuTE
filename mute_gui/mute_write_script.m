function mute_write_script(method)  
    tel = 0;
    tot= sum(method.which);
t = clock;
fid = fopen([method.gen_param.folder '/mute_analysis_scripts.m'],'w');
fprintf(fid,['%%%%this is a script generated by the MuTE gui at ' date '; ' num2str(t(4)) 'h' num2str(t(5)) 'min'.... 
