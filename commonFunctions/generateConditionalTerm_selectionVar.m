function [idCandidates] = generateConditionalTerm_selectionVar (infoSeries,idTargets,idDrivers,multi_uniAnalysis,holdCandidates,partialSelectedVar)
% 
% Syntax:
% 
...
%             idDrivers
            otherVarCandidates            = getOtherVarCandidates_selectionVar(infoSeries,idTargets,idDrivers,partialSelectedVar);
