function [conditionalEntropyTerm,entropyMtx] = conditionalEntropy(dataPreprocessed,idTargets,idConditionalTerm)
% 
% Syntax:
% 
...
% usually the calling function is the method function
    ...
    for i = 1 : numTargets %parfor
        entropyWithoutTarget             = evaluateEntropy(entropyMtx{1,i}(2:end,:));
        entropyWithTarget                = evaluateEntropy(entropyMtx{1,i});
        conditionalEntropyTerm(1,i)      = entropyWithTarget - entropyWithoutTarget;
    end
