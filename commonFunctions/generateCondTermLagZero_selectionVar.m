function [idCandidates] = generateCondTermLagZero_selectionVar (infoSeries,idTargets,idDrivers,multi_uniAnalysis,holdCandidates,partialSelectedVar)
% Syntax:
% 
...
%                           the conditional terms is required, therefore
...
numTargets              = size(idTargets,2);
    ...
    switch multi_uniAnalysis
        case 'multiv'
            ...
            otherVarCandidates            = getOtherVarCandidates_selectionVar(infoSeries,idTargets,reducedDrivers,partialSelectedVar);
